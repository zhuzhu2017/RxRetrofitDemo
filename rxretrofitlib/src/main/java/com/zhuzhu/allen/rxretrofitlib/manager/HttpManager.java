...
public class HttpManager {
     ...
     */
    public void activityConnToServer(BaseApi baseApi) {
        ...
        /*rxjava处理*/
        //加载框设置
        ProgressSubscriber subscriber = new ProgressSubscriber(baseApi, baseApi.getRxAppCompatActivity());
    ...
    public void fragmentConnToServer(final BaseApi baseApi) {
        ...
        /*rxjava处理*/
        //加载框设置
        ProgressSubscriber subscriber = new ProgressSubscriber(baseApi, baseApi.getRxFragment());
        Observable observable = baseApi.getObservable(retrofit)
                /*生命周期管理*/
